...
namespace Complete
{
    public class GameManager : MonoBehaviour
    {
        ...
        private IEnumerator GameLoop()
        {
            ...
            hellipad.GetComponent<StateMachine>().currentState = hellipad.GetComponent<StateMachine>().Idle;
            hellipad.GetComponent<StateMachine>().nbPlayerOnHellipad.Clear();
            hellipad.GetComponent<StateMachine>().teamOwner = 0;
            hellipad.GetComponent<StateMachine>().teamOnHellipad = 0;
